...
export function InstagramEmbedSection() {
  ...
  useEffect(() => {
    ...
    container.innerHTML = NORMALIZED_POPER_EMBED_HTML;

    const blockquote = container.querySelector<HTMLQuoteElement>("blockquote.instagram-media");
    if (blockquote) {
    ...
    const errorTimer = window.setTimeout(() => {
      ...
      renderedEmbed.style.width = "100%";
      renderedEmbed.style.minWidth = "0";
      renderedEmbed.style.maxWidth = "100%";
      renderedEmbed.style.height = "100%";
      renderedEmbed.style.minHeight = "100%";
    }, 6000);
  ...
  return (
    <section id="instagram" className="mt-16 w-full max-w-6xl sm:mt-18">
      ...
      <div className="mx-auto w-full max-w-[42rem]">
        <div className="overflow-hidden rounded-[1.65rem] border border-[rgba(19,15,11,0.08)] bg-white/95 shadow-[0_20px_45px_rgba(24,18,14,0.14)]">
          <div
            ref={embedContainerRef}
            className="instagram-embed-shell flex aspect-[9/16] min-h-[30rem] w-full items-stretch justify-center overflow-hidden p-0 sm:min-h-[38rem] lg:min-h-[46rem]"
